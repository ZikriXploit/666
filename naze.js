...
const nyoutube = ('© zk666ry\nhttps://666xyzkr.blogspot.com')  //ubah di config biar ngk emror
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'zk666ry', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Naze Dev,;;;\nFN:Naze Dev\nitem1.TEL;waid=6285875158363:6285875158363\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/15209657f9d4f59c7ca1e.mp4' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Donate Me!*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_wa.me/6282311414895\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n Ke nomer berikut : 082311414895\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
